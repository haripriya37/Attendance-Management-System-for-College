	...
	{	//echo " in the loop <br>";
		...
		{	//$stuatt[$k]=array();
			...
			{	//echo "<br>condn true<br>";
				...
				$n++;
				$z=1;
				$q2="SELECT `".$dates[$i]."-".$j."` FROM `daily_attendance`";
...
echo ('<th rowspan="3">TH</th>');
echo ('<th rowspan="3">TA</th>');
...
{	
	echo ("<tr>");
	echo "<td>".$y."</td>";	//s. no
	$sql1="SELECT `ht_no` FROM `daily_attendance` WHERE `s_no`=".$y;			//obtain t_timetable of tid
